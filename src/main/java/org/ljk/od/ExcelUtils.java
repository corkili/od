...
public class ExcelUtils {
     ...
     */
    public static XSSFWorkbook createExcelFile(Class clazz, List objs, Map<Integer, List<ExcelBean>> map, String sheetName)
    ...
    public static void createFont(XSSFWorkbook workbook) {
        ...
        fontStyle2.setVerticalAlignment(VerticalAlignment.CENTER);
    }
